-- Script simplificado para criar a estrutura hierárquica
...
-- 2. Adicionar coluna subcategory_id na tabela idea
...
-- 4. Atualizar ideias existentes com subcategorias (exemplos)
...
-- 5. Inserir mais ideias se necessário
